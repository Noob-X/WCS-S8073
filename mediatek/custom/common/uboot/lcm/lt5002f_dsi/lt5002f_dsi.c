...
// cccx
  ...
  //  {0x21, 1, {0x00}},   //Display off for Test Magnum 2012-7-16
	...
	{0x00, 1, {0x00}},
		...
		{0xd4, 40, {			  0x00,0x40,0x00,0x40,0x00,0x40,0x00,0x40, 
	 ...
	 {0xd4, 40, {						
		...
		{0xd4, 40, {			  
								  ...
								  0x00,0x40,0x00,0x40,0x00,0x40,0x00,0x40,
								  0x00,0x40,0x00,0x40,0x00,0x40,0x00,0x40,
								  0x00,0x40,0x00,0x40,0x00,0x40,0x00,0x40}},     // NO == 360 

	{0x00, 1, {0x00}},
	{0xd5, 40, {			0x00, 0x60, 0x00, 0x60, 0x00, 0x5f, 0x00, 0x5f, 
							0x00, 0x5e, 0x00, 0x5e, 0x00, 0x5d, 0x00, 0x5d,
							0x00, 0x5d, 0x00, 0x5c, 0x00, 0x5c, 0x00, 0x5b, 
							0x00, 0x5b, 0x00, 0x5a, 0x00, 0x5a, 0x00, 0x5a, 
							0x00, 0x5b, 0x00, 0x5c, 0x00, 0x5d, 0x00, 0x5d}},
							
	{0xd5, 40, {						
							0x00, 0x5e, 0x00, 0x5f, 0x00, 0x60, 0x00, 0x61, 
							0x00, 0x62, 0x00, 0x63, 0x00, 0x63, 0x00, 0x64, 
							0x00, 0x65, 0x00, 0x66, 0x00, 0x67, 0x00, 0x68, 
							0x00, 0x69, 0x00, 0x69, 0x00, 0x6a, 0x00, 0x6b, 
							0x00, 0x6c, 0x00, 0x6d, 0x00, 0x6e, 0x00, 0x6f, }},
							
	{0xd5, 40, {			
							0x00, 0x6f, 0x00, 0x70, 0x00, 0x71, 0x00, 0x72,
							0x00, 0x73, 0x00, 0x74, 0x00, 0x74, 0x00, 0x75,
							0x00, 0x76, 0x00, 0x77, 0x00, 0x78, 0x00, 0x78, 
							0x00, 0x79, 0x00, 0x7a, 0x00, 0x7b, 0x00, 0x7c, 
							0x00, 0x7d, 0x00, 0x7d, 0x00, 0x7e, 0x00, 0x7f}},
							
	{0xd5, 40, {			0x00, 0x7f, 0x00, 0x7f, 0x00, 0x7f, 0x00, 0x7f,
	...
	{0xd5, 40, {
							0x00, 0x7b, 0x00, 0x7a, 0x00, 0x7a, 0x00, 0x79, 
							0x00, 0x78, 0x00, 0x77, 0x00, 0x76, 0x00, 0x76, 
							0x00, 0x75, 0x00, 0x74, 0x00, 0x73, 0x00, 0x72, 
							0x00, 0x71, 0x00, 0x71, 0x00, 0x70, 0x00, 0x6f, 
							0x00, 0x6e, 0x00, 0x6d, 0x00, 0x6c, 0x00, 0x6c,}},
							
	{0xd5, 40, {		
							0x00, 0x6b, 0x00, 0x6a, 0x00, 0x69, 0x00, 0x68,
							0x00, 0x67, 0x00, 0x66, 0x00, 0x66, 0x00, 0x66, 
							0x00, 0x65, 0x00, 0x65, 0x00, 0x64, 0x00, 0x64, 
							0x00, 0x63, 0x00, 0x63, 0x00, 0x63, 0x00, 0x62, 
							0x00, 0x62, 0x00, 0x61, 0x00, 0x61, 0x00, 0x60}}, 
#endif    
	{0x11,1,   {0x00}}, 
	{REGFLAG_DELAY, 120, {}},
	{0x29,1,	{0x00}}, 
...
//    params->dsi.CONT_DET=0x00;
	...
	params->dsi.pll_div1=0x1A;//34;		// fref=26MHz, fvco=fref*(div1+1)	(div1=0~63, fvco=500MHZ~1GHz)
...
{
	// Work around for Novatek driver IC. If it entered ULP mode, it must be reset before resume./	lcm_init();
	LCM_DBG();
//	lcm_init();
    if(test_cmp_id())
		...
		lcm_init();  
 //   int dd = check_display_normal();
//	LCM_DBG("[LSQ] --check_display_normal() == %d \n ",dd);
//	push_table(lcm_initialization_setting, sizeof(lcm_initialization_setting) / sizeof(struct LCM_setting_table), 1);
}
