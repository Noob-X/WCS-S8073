...
#define M4UERR_WITH_OWNER(string, who, args...) do {                           \
  ...
  aee_kernel_exception(name, "[M4U_K] error:"string,##args);  \
}while(0)
...
static int m4u_perf_timer_off(void);
int m4u_log_on(void);
...
#if defined(MTK_LCDC_ENABLE_M4U)
extern unsigned int _m4u_lcd_init(void);
extern M4U_EXPORT_FUNCTION_STRUCT _m4u_lcdc_func;
#endif

#if defined(MTK_G2D_ENABLE_M4U)
extern unsigned int _m4u_g2d_init(void);
extern M4U_EXPORT_FUNCTION_STRUCT _m4u_g2d_func;
#endif
...
#if defined(MTK_MDP_ENABLE_M4U)
extern M4U_EXPORT_FUNCTION_STRUCT _m4u_mdp_func;
#endif

#if defined(MTK_DEBUG_ENABLE_M4U)
...
static DEFINE_SPINLOCK(gm4upower);
...
int LCD_check_resolution(void)
{
    ...
    isHWDispBonding = (M4U_ReadReg32(EFUSE_CTR_BASE, 0x108) & 0x00000800);
    isMChip = (M4U_ReadReg32(EFUSE_CTR_BASE, 0x108) & 0x08000000);
    M4UDBG("%d\n", isHWDispBonding);
    M4UDBG("%d\n", isMChip);
...
//            if(m4u_module.tsk == NULL)
                m4u_module.tsk = current->group_leader;
//            else
//                m4u_module.tsk = m4u_module.tsk->group_leader;
            
            get_task_struct(m4u_module.tsk);
            ...
            if(ret)
            {
                put_task_struct(m4u_module.tsk);
            	M4UMSG(" MTK_M4U_T_ALLOC_MVA, m4u_alloc_mva failed: %d\n", ret);
            	return -EFAULT;
            }  
            else
            {
                m4u_add_to_garbage_list(a_pstFile, m4u_module.tsk, m4u_module.MVAStart, 
...
//            if(m4u_module.tsk == NULL)
        ...
        {
            unsigned int cur = (unsigned int )current->group_leader;
            M4ULOG("-MTK_M4U_T_GET_TSK_STRUCT, tsk_struct=0x%x \r\n",current);			

            M4U_ASSERT(a_Param);
            ret = copy_to_user((void*)a_Param, &cur, sizeof(void*));
            if(ret)
            {
...
static irqreturn_t MTK_M4U_isr(int irq, void *dev_id)
{
    ...
    switch(irq)
    {
        case MT6577_SMI_LARB0_MMU_IRQ_ID:
        	m4u_base = gM4UBaseAddr[0];
        	m4u_index = 0;
          break;
        case MT6577_SMI_LARB1_MMU_IRQ_ID:
        	m4u_base = gM4UBaseAddr[1];
        	m4u_index = 1;
          break;
        case MT6577_SMI_LARB2_MMU_IRQ_ID:
        	m4u_base = gM4UBaseAddr[2];
        	m4u_index = 2;
          break;
        case MT6577_LARB3_MMU_IRQ_ID:
...
static int __init MTK_M4U_Init(void)
{
    ...
    //Set IRQ   
    if(request_irq(MT6577_SMI_LARB0_MMU_IRQ_ID , MTK_M4U_isr, IRQF_TRIGGER_HIGH, M4U_DEVNAME , NULL))
    {
    ...
    //mt6577_irq_set_sens(MT6577_SMI_LARB0_MMU_IRQ_ID, MT65xx_LEVEL_SENSITIVE);
    //mt6577_irq_set_polarity(MT6577_SMI_LARB0_MMU_IRQ_ID, MT65xx_POLARITY_HIGH);
//    mt6577_irq_unmask(MT6577_SMI_LARB0_MMU_IRQ_ID);
//    enable_irq(MT6577_SMI_LARB0_MMU_IRQ_ID);
    
    if(request_irq(MT6577_SMI_LARB1_MMU_IRQ_ID , MTK_M4U_isr, IRQF_TRIGGER_HIGH, M4U_DEVNAME , NULL))
    {
        M4UERR("request M4U1 IRQ line failed\n");
        return -ENODEV;
    }
    //mt6577_irq_set_sens(MT6577_SMI_LARB1_MMU_IRQ_ID, MT65xx_LEVEL_SENSITIVE);
    //mt6577_irq_set_polarity(MT6577_SMI_LARB1_MMU_IRQ_ID, MT65xx_POLARITY_HIGH);
//    mt6577_irq_unmask(MT6577_SMI_LARB1_MMU_IRQ_ID);
//    enable_irq(MT6577_SMI_LARB1_MMU_IRQ_ID);
    
    if(request_irq(MT6577_SMI_LARB2_MMU_IRQ_ID , MTK_M4U_isr, IRQF_TRIGGER_HIGH, M4U_DEVNAME , NULL))
    {
        M4UERR("request M4U2 IRQ line failed\n");
        return -ENODEV;
    }
    //mt6577_irq_set_sens(MT6577_SMI_LARB2_MMU_IRQ_ID, MT65xx_LEVEL_SENSITIVE);
    //mt6577_irq_set_polarity(MT6577_SMI_LARB2_MMU_IRQ_ID, MT65xx_POLARITY_HIGH);
//    mt6577_irq_unmask(MT6577_SMI_LARB2_MMU_IRQ_ID);
//    enable_irq(MT6577_SMI_LARB2_MMU_IRQ_ID);
    

#ifndef CONFIG_MT6577_FPGA
    if(request_irq(MT6577_LARB3_MMU_IRQ_ID , MTK_M4U_isr, IRQF_TRIGGER_HIGH, M4U_DEVNAME , NULL))
    {
        M4UERR("request M4U3 IRQ line failed\n");
        return -ENODEV;
    }
    //mt6577_irq_set_sens(MT6577_LARB3_MMU_IRQ_ID, MT65xx_LEVEL_SENSITIVE);
    //mt6577_irq_set_polarity(MT6577_LARB3_MMU_IRQ_ID, MT65xx_POLARITY_HIGH);
    //mt6577_irq_unmask(MT6577_LARB3_MMU_IRQ_ID);
//    enable_irq(MT6577_LARB3_MMU_IRQ_ID);
#endif
...
#if defined(MTK_TVOUT_ENABLE_M4U)
    M4UDBG("TVOUT enable M4U \n");
    _m4u_tvout_func.isInit = true;
    _m4u_tvout_func.m4u_dump_reg            = m4u_dump_reg;           
    _m4u_tvout_func.m4u_dump_info           = m4u_dump_info;          
    _m4u_tvout_func.m4u_power_on            = m4u_power_on;           
    _m4u_tvout_func.m4u_power_off           = m4u_power_off;          
    _m4u_tvout_func.m4u_alloc_mva           = m4u_alloc_mva;          
    _m4u_tvout_func.m4u_dealloc_mva         = m4u_dealloc_mva;        
    _m4u_tvout_func.m4u_insert_tlb_range    = m4u_insert_tlb_range;   
    _m4u_tvout_func.m4u_invalid_tlb_range   = m4u_invalid_tlb_range;  
    _m4u_tvout_func.m4u_invalid_tlb_all     = m4u_invalid_tlb_all;    
    _m4u_tvout_func.m4u_manual_insert_entry = m4u_manual_insert_entry;
    _m4u_tvout_func.m4u_config_port         = m4u_config_port;        
    _m4u_tvout_func.m4u_monitor_start       = m4u_monitor_start;      
    _m4u_tvout_func.m4u_monitor_stop        = m4u_monitor_stop;  
    #ifdef ENABLE_GET_PAGES_TUNNING
    _m4u_tvout_func.m4u_dma_cache_maint     = m4u_dma_cache_maint;
    #endif
#endif

#if defined(MTK_LCDC_ENABLE_M4U)
    M4UDBG("LCDC enable M4U \n");

    _m4u_lcdc_func.isInit = true;
    _m4u_lcdc_func.m4u_dump_reg            = m4u_dump_reg;           
    _m4u_lcdc_func.m4u_dump_info           = m4u_dump_info;          
    _m4u_lcdc_func.m4u_power_on            = m4u_power_on;           
    _m4u_lcdc_func.m4u_power_off           = m4u_power_off;          
    _m4u_lcdc_func.m4u_alloc_mva           = m4u_alloc_mva;          
    _m4u_lcdc_func.m4u_dealloc_mva         = m4u_dealloc_mva;        
    _m4u_lcdc_func.m4u_insert_tlb_range    = m4u_insert_tlb_range;   
    _m4u_lcdc_func.m4u_invalid_tlb_range   = m4u_invalid_tlb_range;  
    _m4u_lcdc_func.m4u_invalid_tlb_all     = m4u_invalid_tlb_all;    
    _m4u_lcdc_func.m4u_manual_insert_entry = m4u_manual_insert_entry;
    _m4u_lcdc_func.m4u_config_port         = m4u_config_port;        
    _m4u_lcdc_func.m4u_monitor_start       = m4u_monitor_start;      
    _m4u_lcdc_func.m4u_monitor_stop        = m4u_monitor_stop;  
    #ifdef ENABLE_GET_PAGES_TUNNING
    _m4u_lcdc_func.m4u_dma_cache_maint     = m4u_dma_cache_maint;
    #endif
    _m4u_lcdc_func.m4u_reg_restore         = m4u_reg_restore; 
    _m4u_lcd_init();
#endif

#if defined(MTK_G2D_ENABLE_M4U)
    M4UDBG("MDP enable G2D \n");
    _m4u_g2d_func.isInit = true;
    _m4u_g2d_func.m4u_dump_reg            = m4u_dump_reg;
    _m4u_g2d_func.m4u_dump_info           = m4u_dump_info;
    _m4u_g2d_func.m4u_power_on            = m4u_power_on;
    _m4u_g2d_func.m4u_power_off           = m4u_power_off;
    _m4u_g2d_func.m4u_alloc_mva           = m4u_alloc_mva;
    _m4u_g2d_func.m4u_dealloc_mva         = m4u_dealloc_mva;
    _m4u_g2d_func.m4u_insert_tlb_range    = m4u_insert_tlb_range;
    _m4u_g2d_func.m4u_invalid_tlb_range   = m4u_invalid_tlb_range;
    _m4u_g2d_func.m4u_invalid_tlb_all     = m4u_invalid_tlb_all;
    _m4u_g2d_func.m4u_manual_insert_entry = m4u_manual_insert_entry;
    _m4u_g2d_func.m4u_config_port         = m4u_config_port;
    _m4u_g2d_func.m4u_monitor_start       = m4u_monitor_start;
    _m4u_g2d_func.m4u_monitor_stop        = m4u_monitor_stop;
    #ifdef ENABLE_GET_PAGES_TUNNING
    _m4u_g2d_func.m4u_dma_cache_maint     = m4u_dma_cache_maint;
    #endif
    _m4u_g2d_func.m4u_reg_restore         = m4u_reg_restore;
    _m4u_g2d_init();
#endif

#if defined(MTK_MDP_ENABLE_M4U)
    M4UDBG("MDP enable M4U \n");
    _m4u_mdp_func.isInit = true;
    _m4u_mdp_func.m4u_dump_reg            = m4u_dump_reg;           
    _m4u_mdp_func.m4u_dump_info           = m4u_dump_info;          
    _m4u_mdp_func.m4u_power_on            = m4u_power_on_with_id;           
    _m4u_mdp_func.m4u_power_off           = m4u_power_off_with_id;          
    _m4u_mdp_func.m4u_monitor_start       = m4u_monitor_start;      
    _m4u_mdp_func.m4u_monitor_stop        = m4u_monitor_stop; 
    _m4u_mdp_func.m4u_reset_mva_release_tlb = m4u_reset_mva_release_tlb;
#endif

#if defined(MTK_DEBUG_ENABLE_M4U)
    M4UDBG("debug func in M4U \n");
    _m4u_debug_func.isInit = true;
    _m4u_debug_func.m4u_perf_timer_on       = m4u_perf_timer_on;           
    _m4u_debug_func.m4u_perf_timer_off      = m4u_perf_timer_off;          
    _m4u_debug_func.m4u_log_on              = m4u_log_on;           
    _m4u_debug_func.m4u_log_off             = m4u_log_off;  
    _m4u_debug_func.m4u_mau_check_pagetable = m4u_mau_check_pagetable;           
    _m4u_debug_func.m4u_mau_get_physical_port = m4u_mau_get_physical_port;   
    _m4u_debug_func.m4u_debug_command       = m4u_debug_command;            
#endif
...
static void __exit MTK_M4U_Exit(void)
{
    ...
    //Release IRQ
    free_irq(MT6577_SMI_LARB0_MMU_IRQ_ID , NULL);
    free_irq(MT6577_SMI_LARB1_MMU_IRQ_ID , NULL);
    free_irq(MT6577_SMI_LARB2_MMU_IRQ_ID , NULL);
    free_irq(MT6577_LARB3_MMU_IRQ_ID , NULL);
